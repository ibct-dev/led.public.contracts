...
// class legis_msig_tester : public tester {
//    public:
//     legis_msig_tester() {
...
//         base_tester::push_action(N(led.token), N(transfer), manager, mutable_variant_object()("from", from)("to", to)("quantity", asset::from_string(amount))("memo", ""));
//     }
...
// transaction legis_msig_tester::reqauth(account_name from, const vector<permission_level>& auths, const fc::microseconds& max_serialization_time) {
//     fc::variants v;
//     for (auto& level : auths) {
//         v.push_back(fc::mutable_variant_object()("actor", level.actor)("permission", level.permission));
//     }
//     variant pretty_trx = fc::mutable_variant_object()("expiration", "2020-01-01T00:30")("ref_block_num", 2)("ref_block_prefix", 3)("max_net_usage_words", 0)("max_cpu_usage_ms", 0)("delay_sec", 0)("actions", fc::variants({fc::mutable_variant_object()("account", name(config::system_account_name))("name", "reqauth")("authorization", v)("data", fc::mutable_variant_object()("from", from))}));
//     transaction trx;
//     abi_serializer::from_variant(pretty_trx, trx, get_resolver(), max_serialization_time);
//     return trx;
// }

// BOOST_AUTO_TEST_SUITE(legis_msig_tests)

// BOOST_FIXTURE_TEST_CASE(propose_approve_execute, legis_msig_tester)
// try {
//     auto trx = reqauth("alice", {permission_level{N(alice), config::active_name}}, abi_serializer_max_time);

//     push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "first")("trx", trx)("requested", vector<permission_level>{{N(alice), config::active_name}}));

//     //fail to execute before approval
//     BOOST_REQUIRE_EXCEPTION(push_action(N(alice), N(exec), mvo()("proposer", "alice")("proposal_name", "first")("executer", "alice")),
//                             eosio_assert_message_exception,
//                             eosio_assert_message_is("transaction authorization failed"));

//     //approve and execute
//     push_action(N(alice), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(alice), config::active_name}));

//     transaction_trace_ptr trace;
//     control->applied_transaction.connect([&](const transaction_trace_ptr& t) { if (t->scheduled) { trace = t; } });
//     push_action(N(alice), N(exec), mvo()("proposer", "alice")("proposal_name", "first")("executer", "alice"));
...
// BOOST_FIXTURE_TEST_CASE(propose_approve_unapprove, legis_msig_tester)
// try {
//     auto trx = reqauth("alice", {permission_level{N(alice), config::active_name}}, abi_serializer_max_time);
...
//     push_action(N(alice), N(unapprove), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(alice), config::active_name}));
...
// BOOST_FIXTURE_TEST_CASE(propose_approve_by_two, legis_msig_tester)
// try {
...
//     push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "first")("trx", trx)("requested", vector<permission_level>{{N(alice), config::active_name}, {N(bob), config::active_name}}));
...
//     push_action(N(bob), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(bob), config::active_name}));
...
// BOOST_FIXTURE_TEST_CASE(propose_with_wrong_requested_auth, legis_msig_tester)
// try {
//     auto trx = reqauth("alice", vector<permission_level>{{N(alice), config::active_name}, {N(bob), config::active_name}}, abi_serializer_max_time);
//     //try with not enough requested auth
//     BOOST_REQUIRE_EXCEPTION(push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "third")("trx", trx)("requested", vector<permission_level>{{N(alice), config::active_name}})),
//                             eosio_assert_message_exception,
//                             eosio_assert_message_is("transaction authorization failed"));
// }
// FC_LOG_AND_RETHROW()

// BOOST_FIXTURE_TEST_CASE(big_transaction, legis_msig_tester)
// try {
//     vector<permission_level> perm = {{N(alice), config::active_name}, {N(bob), config::active_name}};
//     auto wasm = contracts::util::exchange_wasm();

//     variant pretty_trx = fc::mutable_variant_object()("expiration", "2020-01-01T00:30")("ref_block_num", 2)("ref_block_prefix", 3)("max_net_usage_words", 0)("max_cpu_usage_ms", 0)("delay_sec", 0)("actions", fc::variants({fc::mutable_variant_object()("account", name(config::system_account_name))("name", "setcode")("authorization", perm)("data", fc::mutable_variant_object()("account", "alice")("vmtype", 0)("vmversion", 0)("code", bytes(wasm.begin(), wasm.end())))}));

//     transaction trx;
//     abi_serializer::from_variant(pretty_trx, trx, get_resolver(), abi_serializer_max_time);

//     push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "first")("trx", trx)("requested", perm));
...
// BOOST_FIXTURE_TEST_CASE(update_system_contract_all_approve, legis_msig_tester)
// try {
...
//     set_authority(N(led), "active", authority(1, vector<key_weight>{{get_private_key("led", "active").get_public_key(), 1}}, vector<permission_level_weight>{{{N(led.prods), config::active_name}, 1}}), "owner",
...
//     vector<permission_level> perm = {{N(alice), config::active_name}, {N(bob), config::active_name}, {N(carol), config::active_name}};

//     vector<permission_level> action_perm = {{N(led), config::active_name}};

//     auto wasm = contracts::util::test_api_wasm();

//     variant pretty_trx = fc::mutable_variant_object()("expiration", "2020-01-01T00:30")("ref_block_num", 2)("ref_block_prefix", 3)("max_net_usage_words", 0)("max_cpu_usage_ms", 0)("delay_sec", 0)("actions", fc::variants({fc::mutable_variant_object()("account", name(config::system_account_name))("name", "setcode")("authorization", action_perm)("data", fc::mutable_variant_object()("account", name(config::system_account_name))("vmtype", 0)("vmversion", 0)("code", bytes(wasm.begin(), wasm.end())))}));
...
//     push_action(N(bob), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(bob), config::active_name}));
//     //approve by carol
//     push_action(N(carol), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(carol), config::active_name}));
...
// BOOST_FIXTURE_TEST_CASE(update_system_contract_major_approve, legis_msig_tester)
// try {
...
//     vector<permission_level> perm = {{N(alice), config::active_name}, {N(bob), config::active_name}, {N(carol), config::active_name}, {N(apple), config::active_name}};
...
//     //approve by apple
//     push_action(N(apple), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(apple), config::active_name}));
//     // execute by alice to replace the led system contract
//     transaction_trace_ptr trace;
//     control->applied_transaction.connect([&](const transaction_trace_ptr& t) { if (t->scheduled) { trace = t; } });

//     // execute by another producer different from proposer
//     push_action(N(apple), N(exec), mvo()("proposer", "alice")("proposal_name", "first")("executer", "apple"));
...
// BOOST_FIXTURE_TEST_CASE(propose_approve_invalidate, legis_msig_tester)
// try {
//     auto trx = reqauth("alice", {permission_level{N(alice), config::active_name}}, abi_serializer_max_time);
...
//     //invalidate
//     push_action(N(alice), N(invalidate), mvo()("account", "alice"));
...
// BOOST_FIXTURE_TEST_CASE(propose_invalidate_approve, legis_msig_tester)
// try {
//     auto trx = reqauth("alice", {permission_level{N(alice), config::active_name}}, abi_serializer_max_time);
...
//     push_action(N(bob), N(exec), mvo()("proposer", "alice")("proposal_name", "first")("executer", "bob"));
...
// BOOST_FIXTURE_TEST_CASE(approve_execute_old, legis_msig_tester)
// try {
//     set_code(N(led.msig), contracts::util::msig_wasm_old());
//     set_abi(N(led.msig), contracts::util::msig_abi_old().data());
//     produce_blocks();

//     //propose with old version of led.msig
//     auto trx = reqauth("alice", {permission_level{N(alice), config::active_name}}, abi_serializer_max_time);
//     push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "first")("trx", trx)("requested", vector<permission_level>{{N(alice), config::active_name}}));
...
// BOOST_FIXTURE_TEST_CASE(approve_unapprove_old, legis_msig_tester)
// try {
//     set_code(N(led.msig), contracts::util::msig_wasm_old());
//     set_abi(N(led.msig), contracts::util::msig_abi_old().data());
//     produce_blocks();
...
// BOOST_FIXTURE_TEST_CASE(approve_by_two_old, legis_msig_tester)
// try {
//     set_code(N(led.msig), contracts::util::msig_wasm_old());
//     set_abi(N(led.msig), contracts::util::msig_abi_old().data());
//     produce_blocks();
...
// BOOST_FIXTURE_TEST_CASE(approve_with_hash, legis_msig_tester)
// try {
//     auto trx = reqauth("alice", {permission_level{N(alice), config::active_name}}, abi_serializer_max_time);
...
//     BOOST_REQUIRE_EXCEPTION(push_action(N(alice), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(alice), config::active_name})("proposal_hash", not_trx_hash)),
//                             eosio::chain::crypto_api_exception,
//                             fc_exception_message_is("hash mismatch"));

//     //approve and execute
//     push_action(N(alice), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(alice), config::active_name})("proposal_hash", trx_hash));
...
// BOOST_FIXTURE_TEST_CASE(switch_proposal_and_fail_approve_with_hash, legis_msig_tester)
// try {
...
//     push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "first")("trx", trx1)("requested", vector<permission_level>{{N(alice), config::active_name}}));
...
//     push_action(N(alice), N(cancel), mvo()("proposer", "alice")("proposal_name", "first")("canceler", "alice"));

//     push_action(N(alice), N(propose), mvo()("proposer", "alice")("proposal_name", "first")("trx", trx2)("requested", vector<permission_level>{{N(alice), config::active_name}, {N(alice), config::owner_name}}));

//     //fail to approve with hash meant for old proposal
//     BOOST_REQUIRE_EXCEPTION(push_action(N(alice), N(approve), mvo()("proposer", "alice")("proposal_name", "first")("level", permission_level{N(alice), config::active_name})("proposal_hash", trx1_hash)),
//                             eosio::chain::crypto_api_exception,
//                             fc_exception_message_is("hash mismatch"));
// }
// FC_LOG_AND_RETHROW()
