...
//     action_result burn(account_name issuer, account_name owner asset quantity, string memo) {
//         return push_action(issuer, N(burn), mvo()("owner", owner)("quantity", quantity)("memo", memo));
//     }
...
// BOOST_FIXTURE_TEST_CASE(create_max_supply, legis_token_tester)
// try {
