...
const static uint64_t system_account_name    = N(led);
const static uint64_t null_account_name      = N(led.null);
const static uint64_t producers_account_name = N(led.prods);
...
const static uint64_t eosio_auth_scope       = N(led.auth);
const static uint64_t eosio_all_scope        = N(led.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(led.any);
const static uint64_t eosio_code_name = N(led.code);
