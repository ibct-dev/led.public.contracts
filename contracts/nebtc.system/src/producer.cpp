...
namespace eosiosystem {
   ...
   void system_contract::buyservice( const name& buyer, const asset& quantity, const name& frontier ) {
      ...
      check( quantity.amount < 100000001, "must quantity below 10000 NEBTC" );
   ...
   void system_contract::buynebtcservice( const name& buyer, const asset& quantity, const name& frontier ) {
      require_auth( buyer );
      require_recipient( buyer );
      require_recipient( frontier );
   ...
   void system_contract::buynebtcsvcdom( const name& buyer, const asset& quantity, const name& frontier, const name& provider ) {
      require_auth( buyer );
      require_recipient( buyer );
      require_recipient( frontier );
