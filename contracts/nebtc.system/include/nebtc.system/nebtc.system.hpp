...
#include <nebtc.system/exchange_state.hpp>
#include <nebtc.system/native.hpp>
...
#define REMOVE_SECONDARY_INDEX( ITR, TYPE, CODE, SCOPE, TABLE ) \
   ...
   struct [[eosio::table("global"), eosio::contract("nebtc.system")]] legis_global_state : eosio::blockchain_parameters {
   ...
   struct [[eosio::table("global2"), eosio::contract("nebtc.system")]] legis_global_state2 {
      legis_global_state2(){}
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] producer_info2 {
      name                    owner;
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] producer_info {
      name                    owner;
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] frontier_info {
      name                    owner;
      bool                    is_active;
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] interior_info {
      name            owner;
      bool            is_active;
      std::string     url;
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] buyer_info {
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] voter_info {
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] proxy_info {
      /**
         *  Set proxy info
         *
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      int64_t       ram_bytes = 0;
    ...
    */
   struct [[eosio::table, eosio::contract("nebtc.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
   ...
   struct [[eosio::table, eosio::contract("nebtc.system")]] refund_request {
      name            owner;
   ...
   class [[eosio::contract("nebtc.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{"nebtc.token"_n};
         static constexpr eosio::name ram_account{"nebtc.ram"_n};
         static constexpr eosio::name ramfee_account{"nebtc.ramfee"_n};
         static constexpr eosio::name stake_account{"nebtc.stake"_n};
         static constexpr eosio::name bpay_account{"nebtc.bpay"_n};
         static constexpr eosio::name cpay_account{"nebtc.cpay"_n};
         static constexpr eosio::name vpay_account{"nebtc.vpay"_n};
         static constexpr eosio::name saving_account{"nebtc.saving"_n};
         static constexpr eosio::name losa_account{"losa"_n};
         static constexpr eosio::name null_account{"nebtc.null"_n};
         ...
         static symbol get_core_symbol( name system_account = "nebtc"_n ) {
         ...
         [[eosio::action]]
         void buynebtcservice( const name& buyer, const asset& quantity, const name& frontier );
         
         [[eosio::action]]
         void buynebtcsvcdom( const name& buyer, const asset& quantity, const name& frontier, const name& provider );
         ...
         using buynebtcservice_action = eosio::action_wrapper<"buynebtcservice"_n, &system_contract::buynebtcservice>;
         using buynebtcsvcdom_action = eosio::action_wrapper<"buynebtcsvcdom"_n, &system_contract::buynebtcsvcdom>;
